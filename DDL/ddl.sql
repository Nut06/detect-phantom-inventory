-- 1. Part 
CREATE TABLE Part (
    partID NUMBER GENERATED BY DEFAULT AS IDENTITY,
...
poDetailID NUMBER GENERATED ALWAYS AS IDENTITY, 
purchaseOrderID NUMBER, 
NUMBER, qty NUMBER(10) NOT NULL, 
costPerUnit NUMBER(15, 2), 
CONSTRAINT pk_po_detail_new PRIMARY KEY (poDetailID), 
CONSTRAINT fk_pod_header FOREIGN KEY (purchaseOrderID) REFERENCES PurchaseOrder(purchaseOrderID) ON DELETE CASCADE, CONSTRAINT fk_pod_prod FOREIGN KEY (productID) REFERENCES Product(productID) 
);

-- 15. ReceiptDetail
CREATE TABLE ReceiptDetail ( 
receiptDetailID NUMBER GENERATED ALWAYS AS IDENTITY, 
receiptID NUMBER, 
productID NUMBER, 
